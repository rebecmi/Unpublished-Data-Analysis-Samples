...
* 1) Import data analysis file - OMITTED b/c of personal file paths
* 2) Descriptives
...
********Exposure**********
tab r13stroke_us if eligible == 1

tab stroke_time if stroke_time >0 & eligible==1 
********Outcome***********
...
*no multicollienarity with exposure,keep in model

///Time-varying stroke variable 
global s2regressvars i.stroke_time age i.obese i.r13lbrf_us wealth4 i.r13mstat_us i.r13hearte i.r13diabe i.r13hibpe i.mingrp i.r13drinkstat i.r13smokestat i.us_educ
...
*General Cognitive Function*
regress fgcp $s2regressvars if eligible == 1
predict predicted_gen
predict residual_gen, residual
predict rstandard_gen, rstandard
histogram residual_gen
...
*Memory*
regress fmem $s2regressvars if eligible == 1
predict predicted_mem
predict residual_mem, residual
predict rstandard_mem, rstandard
histogram residual_mem
...
*Executive Function*
regress fexf $s2regressvars if eligible == 1
predict predicted_ex
predict residual_ex, residual
predict rstandard_ex, rstandard
histogram residual_ex
...
*Language*
regress flang $s2regressvars if eligible == 1
predict predicted_lang
predict residual_lang, residual
predict rstandard_lang, rstandard
histogram residual_lang
...
*Orientation*
regress forient $s2regressvars if eligible == 1
predict predicted_or
predict residual_or, residual
predict rstandard_or, rstandard
histogram residual_or
...
//Longitudinal stroke variable 

** General
regress fgcp $s2regressvars if eligible==1 [pweight=r13wtrespe]

** Memory
regress fmem $s2regressvars if eligible==1 [pweight=r13wtrespe]

** Executive function
regress fexf $s2regressvars if eligible==1 [pweight=r13wtrespe]

** Language
regress flang $s2regressvars if eligible==1 [pweight=r13wtrespe]
...
global em_us i.r13stroke_us##i.woman age i.obese i.r13lbrf_us wealth4 i.r13mstat_us i.r13hearte i.r13diabe i.r13hibpe i.mingrp i.r13drinkstat i.r13smokestat i.us_educ
