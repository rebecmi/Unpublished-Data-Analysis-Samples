...
## Sex
seprop <- table(c19cs_soceduexe$sex_lab)
seprop
prop.table(seprop)*100

## Race
raceprop <- table(c19cs_soceduexe$race_lab)
raceprop
prop.table(raceprop)*100

## Education
eduprop <- table(c19cs_soceduexe$educ_lab)
eduprop
prop.table(eduprop)*100

## Exercise Routine
exeprop <- table(c19cs_soceduexe$exe_difflab)
exeprop
prop.table(exeprop)*100

## Social Routine
socprop <- table(c19cs_soceduexe$soc_difflab)
socprop
prop.table(socprop)*100

## Education/Creative Routine
creatprop <- table(c19cs_soceduexe$edu_difflab)
creatprop
prop.table(creatprop)*100

## CES-D
summary(c19cs_soceduexe$t36_cesd_tot)
sd(c19cs_soceduexe$t36_cesd_tot)

## Beck Anxiety
summary(c19cs_soceduexe$t36_anx_tot)
sd(c19cs_soceduexe$t36_anx_tot)
## UCLA Lonely
summary(c19cs_soceduexe$t36_lonely_tot)
sd(c19cs_soceduexe$t36_lonely_tot)
```
